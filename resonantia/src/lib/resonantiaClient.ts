...
export const resonantiaClient: ResonantiaClient = {
  ...
  getOpenAiByoKeyStatus: () => withClient((client) => client.getOpenAiByoKeyStatus()),
  setOpenAiByoKey: (key) => withClient((client) => client.setOpenAiByoKey(key)),
  clearOpenAiByoKey: () => withClient((client) => client.clearOpenAiByoKey()),
  setModelProvider: (provider) => withClient((client) => client.setModelProvider(provider)),
  setOpenAiConfig: (baseUrl, model) => withClient((client) => client.setOpenAiConfig(baseUrl, model)),
